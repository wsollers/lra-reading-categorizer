...
Canonical overlay: docs/governance/repo-overlays/lra-reading-categorizer.md
...
Repository: `lra-reading-categorizer`
Canonical task router: `docs/agent-task-index.md`
Canonical repo overlay: `docs/governance/repo-overlays/lra-reading-categorizer.md`
